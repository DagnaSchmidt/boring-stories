...
const StoryPrev = ({data}) => {
    ...
    // const imageLink = `https://drive.google.com/uc?id=${prevImg}`;
  ...
  return (
    <div className='w-52 border-4 border-secondary bg-primary flex flex-col gap-2'>
        <button onClick={openStory} className='w-full'>
            <img src={`https://lh3.googleusercontent.com/d/${prevImg}`} alt={altText} className='grayscale hover:grayscale-0 w-full h-32 object-cover' />
        </button>
